...
export default function SideNav({
  ...
  return (
    <aside className={`fixed top-0 left-0 h-screen md:p-0 md:pt-16 md:left-8 w-84 md:w-80 shrink-0 z-80 md:pointer-events-none ${isOpen ? `h-full w-full md:w-80`: `h-8 w-auto`}`}>
      <div className={`mt-4 ml-4 h-full md:mt-0 md:ml-0 pt-4 pl-4 md:pt-0 md:pl-0 flex flex-col gap-8 bg-background md:bg-transparent rounded-sm ${isOpen ? `pb-8` : `h-8 pb-0`}`}>
        <button
